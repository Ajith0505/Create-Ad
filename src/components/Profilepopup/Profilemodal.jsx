...
function Profilemodal() {
  ...
  return (
    <div className="profile-modal" ref={menuRef}>
      ...
      <div className="profile-category profile-hov">
        <div>
          <img src="images/layout-cards.svg" alt="user-6" />
        </div>
        <div className="profile-name-div">
          <p className="profile-cat-name">
            My advertisements
          </p>
        </div>
      </div>
      <div className="profile-category profile-hov">
        <div>
          <img src="images/heart-line.svg" alt="user-6" />
        </div>
        <div className="profile-name-div">
          <p className="profile-cat-name" onClick={changeRoute}>
            My favorites
          </p>
        </div>
      </div>
      <div className="profile-category profile-hov">
        <div>
          <img src="images/logout-box-r-line.svg" alt="user-6" />
        </div>
        <div className="profile-name-div" onClick={setLogout}>
          <p className="profile-cat-name">
            Logout
          </p>
        </div>
